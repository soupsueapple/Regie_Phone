...
public class FWYCMainFragment extends BaseFragment{
    ...
    private void abnormalPostCount(){
        final KeerAlertDialog pd = showKeerAlertDialog(R.string.loading);
        pd.show();

        RequestParams params = new RequestParams();
        params.put("data","{\"postHandler\":[],\"preHandler\":[],\"executor\": {\"url\":\""+ Constant.MWB_Base_URL+"marketInspect!abnormalPostCount.action?privilegeFlag=VIEW&_query.yearMonth="+monthTv.getText().toString()+"\",\"type\":\"WebExecutor\"},\"app\":\"1001\"}");
    ...
    class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerHolder>{
        ...
        public RecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            RecyclerHolder holder = new RecyclerHolder(LayoutInflater.from(FWYCMainFragment.this.getActivity()).inflate(R.layout.fragment_service_record_recylerview_item, parent, false));
            return holder;
        }
