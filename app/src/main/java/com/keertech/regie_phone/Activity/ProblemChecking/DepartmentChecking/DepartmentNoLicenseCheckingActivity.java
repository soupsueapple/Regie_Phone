...
public class DepartmentNoLicenseCheckingActivity extends BaseActivity{

    private TextView customerCheckingTv;
    ...
    private void assignViews() {
        customerCheckingTv = (TextView) findViewById(R.id.customer_checking_tv);
        ...
        customerCheckingTv.setOnClickListener(new ViewClickVibrate(){

            @Override
            public void onClick(View view) {
                super.onClick(view);

                Intent intent = new Intent(DepartmentNoLicenseCheckingActivity.this, DepartmentCustomerCheckingActivity.class);
        ...
        addCustomerTv.setOnClickListener(new ViewClickVibrate(){
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(DepartmentNoLicenseCheckingActivity.this, ChooseNotHasLicenseActivity.class);
                intent.putExtra("id", id);
                startActivity(intent);
            }
        });
        ...
        checkedRecordTv.setOnClickListener(new ViewClickVibrate(){
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(DepartmentNoLicenseCheckingActivity.this, CheckedReportActivity.class);
                intent.putExtra("object", object.toString());
                intent.putExtra("id", id);
                startActivity(intent);
            }
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(DepartmentNoLicenseCheckingActivity.this));
    ...
    private void loadCust(){
        ...
        HttpClient.post(Constant.EXEC, requestParams, new JsonHttpResponseHandler() {
                ...
                try {
                    if (StringUtility.isSuccess(response)) {
                        ...
                        if (StringUtility.isSuccess(message)) {
                            ...
                            showToast(response.getString("message"), DepartmentNoLicenseCheckingActivity.this);
                        }
                    } else {
                        showToast(response.getString("message"), DepartmentNoLicenseCheckingActivity.this);
                    }
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                pd.dismiss();
                showNetworkError(DepartmentNoLicenseCheckingActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_department_nolicense_checking);
        setToolbarTitle("无证户");
        showBack();
    ...
    protected void onResume() {
        ...
        if(Constant.isRefresNoJZZZS){
            ...
            Constant.isRefresJJFinish = true;
        }
    }
    ...
    class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerHolder>{
        ...
        public RecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            RecyclerHolder holder = new RecyclerHolder(LayoutInflater.from(DepartmentNoLicenseCheckingActivity.this).inflate(R.layout.activity_department_nolicense_checking_recyclerview_item, parent, false));
            return holder;
        }
        ...
        public void onBindViewHolder(RecyclerHolder holder, int position) {
            ...
            try {
                ...
                holder.addressTv.setText(noLiceRegistry.getString("address"));
                ...
                final String noLiceRegistryId = noLiceRegistry.getString("id");
                ...
                holder.checkingTv.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("noLiceRegistryId", noLiceRegistryId);
                        intent.putExtra("postType", 0);
                        intent.putExtra("noLice", true);
                        intent.putExtra("ck", ck);
                        startActivity(intent);
                    }
                });
