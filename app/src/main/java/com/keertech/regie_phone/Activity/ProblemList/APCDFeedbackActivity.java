...
public class APCDFeedbackActivity extends BaseActivity{
    ...
    private void assignViews() {
        ...
        startDateLl.setOnClickListener(new ViewClickVibrate(){
            ...
            public void onClick(View view) {
                super.onClick(view);
                DatePickerDialog dp =  new DatePickerDialog(APCDFeedbackActivity.this,
    ...
    private void searchData(String billcode, String startDate, String endDate) {
        ...
        HttpClient.get(Constant.EXEC + "?data=%7B%22postHandler%22:%5B%5D,%22preHandler%22:%5B%5D,%22executor%22:%7B%22url%22:%22" + Constant.MIIS_Base_URL +
                        "apcdwarningDispose!searchBeans.action%3fprivilegeFlag=VIEW" + other + "%26_query.statusFlag=true%22,%22type%22:%22WebExecutor%22%7D,%22app%22:%221003%22%7D",
                null, new JsonHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                        ...
                        try {
                            if(StringUtility.isSuccess(response)) {
                                ...
                                showToast(response.getString("message"), APCDFeedbackActivity.this);
                            }
                    ...
                    public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                        pd.dismiss();
                        showNetworkError(APCDFeedbackActivity.this);
    ...
    class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerHolder>{
        ...
        public RecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            RecyclerHolder holder = new RecyclerHolder(LayoutInflater.from(APCDFeedbackActivity.this).inflate(R.layout.activity_apcd_feedback_recyclerview_item, parent, false));
            return holder;
        }
        ...
        public void onBindViewHolder(RecyclerHolder holder, int position) {
            ...
            try {
                ...
                String primaryKeySecond = object.getString("primaryKeySecond");


                String writeDate = object.getString("writeDate");
                int problemStatus = object.getInt("problemStatus");

                String primaryStr = "";

                if(primaryKeySecond.equals("PLAN")){
                    primaryStr = "未制定检查计划";
                }else if(primaryKeySecond.equals("RESULT")){
                    primaryStr = "未反馈检查结果";
                }else if(primaryKeySecond.equals("CHECK")){
                    primaryStr = "未提交检查对象";
                }

                holder.problemNoTv.setText(billcode);
                holder.commonTv.setText(name);
                holder.departmentTv.setText(simplyName);
                holder.typeTv.setText(primaryStr);
                holder.dateTv.setText(writeDate);
                holder.statusTv.setText(problemStatus==1?"已完成":"未完成");
