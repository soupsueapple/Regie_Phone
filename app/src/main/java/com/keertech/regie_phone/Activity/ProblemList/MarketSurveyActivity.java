...
public class MarketSurveyActivity extends BaseActivity{
    ...
    private void assignViews() {
        ...
        startDateLl.setOnClickListener(new ViewClickVibrate(){
            ...
            public void onClick(View view) {
                super.onClick(view);
                DatePickerDialog dp =  new DatePickerDialog(MarketSurveyActivity.this,
    ...
    private void searchData(String billcode, String startDate, String endDate){
        ...
        HttpClient.get(Constant.EXEC + "?data=%7B%22postHandler%22:%5B%5D,%22preHandler%22:%5B%5D,%22executor%22:%7B%22url%22:%22" + Constant.MIIS_Base_URL  +
                        "marketExamineDispose!searchBeans.action%3fprivilegeFlag=VIEW" + other + "%26_query.statusFlag=true%22,%22type%22:%22WebExecutor%22%7D,%22app%22:%221003%22%7D",
...
//                            response = new JSONObject(response.toString().replaceAll(" ",""));
                            if(StringUtility.isSuccess(response)) {
                                ...
                                showToast(response.getString("message"), MarketSurveyActivity.this);
                            }
                    ...
                    public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                        pd.dismiss();
                        showNetworkError(MarketSurveyActivity.this);
    ...
    class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerHolder>{
        ...
        public RecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            RecyclerHolder holder = new RecyclerHolder(LayoutInflater.from(MarketSurveyActivity.this).inflate(R.layout.activity_market_survey_recyclerview_item, parent, false));
            return holder;
        }
        ...
        public void onBindViewHolder(RecyclerHolder holder, int position) {
            ...
            try {
                ...
                String compcontent = object.getString("compcontent");
                ...
                holder.contentTv.setText(compcontent);
