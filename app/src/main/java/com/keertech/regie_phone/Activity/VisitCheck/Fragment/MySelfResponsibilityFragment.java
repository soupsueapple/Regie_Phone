...
import com.keertech.regie_phone.Activity.VisitCheck.MyselfResponsibility.MyselfResponsibilityInfoActivity;
...
public class MySelfResponsibilityFragment extends BaseFragment{
    ...
    public void onResume() {
        ...
        if(Constant.isRefreshBRZR){
            Constant.isRefreshBRZR = false;
    ...
    private void verifyList() {
        ...
        params.put("data", "{\"postHandler\":[],\"preHandler\":[],\"executor\":{\"url\":\"" + Constant.MWB_Base_URL + "marketSecretlyCheckMobile!verifyList.action\",\"type\":\"WebExecutor\"},\"app\":\"1001\"}");
    ...
    class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerHolder>{
        ...
        public RecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            RecyclerHolder holder = new RecyclerHolder(LayoutInflater.from(MySelfResponsibilityFragment.this.getActivity()).inflate(R.layout.fragment_theplace_recyclerview_item, parent, false));
            return holder;
        }
            ...
            try {
                ...
                holder.searchTv.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(getActivity(), MyselfResponsibilityInfoActivity.class);
