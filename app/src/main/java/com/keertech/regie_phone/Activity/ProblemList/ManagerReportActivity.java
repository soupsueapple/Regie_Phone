...
public class ManagerReportActivity extends BaseActivity{
    ...
    private void assignViews() {
        ...
        startDateLl.setOnClickListener(new ViewClickVibrate(){
            ...
            public void onClick(View view) {
                super.onClick(view);
                DatePickerDialog dp =  new DatePickerDialog(ManagerReportActivity.this,
    ...
    private void searchData(String billcode, String startDate, String endDate) {
        ...
        HttpClient.get(Constant.EXEC + "?data=%7B%22postHandler%22:%5B%5D,%22preHandler%22:%5B%5D,%22executor%22:%7B%22url%22:%22" + Constant.MIIS_Base_URL +
                        "clientInformDispose!searchBeans.action%3fprivilegeFlag=VIEW" + other + "%26_query.statusFlag=true%22,%22type%22:%22WebExecutor%22%7D,%22app%22:%221003%22%7D",
                null, new JsonHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                        ...
                        try {
                            if(StringUtility.isSuccess(response)) {
                                ...
                                showToast(response.getString("message"), ManagerReportActivity.this);
                            }
                    ...
                    public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                        pd.dismiss();
                        showNetworkError(ManagerReportActivity.this);
    ...
    class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerHolder>{
        ...
        public RecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            RecyclerHolder holder = new RecyclerHolder(LayoutInflater.from(ManagerReportActivity.this).inflate(R.layout.activity_apcd_feedback_recyclerview_item, parent, false));
            return holder;
        }
        ...
        public void onBindViewHolder(RecyclerHolder holder, int position) {
            ...
            try {
                ...
                String customermanager = object.getString("customermanager");
                String disobey = object.getString("disobey");
                ...
                holder.commonTv.setText(customermanager);
                holder.typeTv.setText(disobey);
