...
import com.keertech.regie_phone.Activity.VisitCheck.SuperintendentVerify.SuperintendentVerifyInfoActivity;
...
public class SuperintendentVerifyFragment extends BaseFragment{
    ...
    public void onResume() {
        super.onResume();
        if(Constant.isRefreshSZQR){
            Constant.isRefreshSZQR = false;
    ...
    private void confirmList() {
        ...
        params.put("data", "{\"postHandler\":[],\"preHandler\":[],\"executor\":{\"url\":\"" + Constant.MWB_Base_URL + "marketSecretlyCheckMobile!confirmList.action\",\"type\":\"WebExecutor\"},\"app\":\"1001\"}");
    ...
    class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerHolder>{
        ...
        public RecyclerHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            RecyclerHolder holder = new RecyclerHolder(LayoutInflater.from(SuperintendentVerifyFragment.this.getActivity()).inflate(R.layout.fragment_theplace_recyclerview_item, parent, false));
            return holder;
        }
            ...
            try {
                ...
                holder.searchTv.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(getActivity(), SuperintendentVerifyInfoActivity.class);
